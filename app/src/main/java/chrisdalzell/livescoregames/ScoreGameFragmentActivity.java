...
public class ScoreGameFragmentActivity extends FragmentActivity {
     ...
     * {@link android.support.v4.view.ViewPager} contained inside R.layout.activity_draw_fragment.
     *
     * <p>A {@link chrisdalzell.livescoregames.ScoreGamePagerAdapter} will be instantiated to hold the different pages of
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetGameInfo().execute(GameSelectionActivity.SERVER_ADDRESS + "get_game.php");
    }
